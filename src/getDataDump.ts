...
// eslint-disable-next-line complexity -- hard to break up this function
async function getDataDump(
  ...
  try {
    ...
    while (tables.length > 0) {
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion -- while guard ensures this is right
      ...
      // eslint-disable-next-line no-await-in-loop -- intentional await to process tables sequentially
  ...
  // eslint-disable-next-line @typescript-eslint/await-thenable -- types are wrong - this can be a promise
